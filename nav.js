(function () {
  ...
  document.body.insertAdjacentHTML('afterbegin', '<nav>' +
    '<a href="' + B + '/" class="logo" style="display:flex;align-items:center;gap:0.7rem;text-decoration:none;">' +
      ...
      '<span style="font-family:Playfair Display,serif;font-size:1.55rem;font-weight:400;color:#1a3f6f;line-height:1;letter-spacing:-0.04em;white-space:nowrap;">Conner Marketing Solutions</span>' +
    '</a>' +
    '<ul>' +
